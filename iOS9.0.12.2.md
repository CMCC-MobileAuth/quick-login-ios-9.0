...
6. 关于iPhoneXS Max以及iPhoneXR双卡的适配问题：
...
```objective-c
[UASDKLogin.shareLogin registerAppId:APPID appKey:APPKEY encrypType:@"rsa2048"];
```
...
| 105302 | appid不在白名单                                              |
| 105313 | 非法请求                                                     |
| 200022        | 无网络（4G网络下，App未被允许访问蜂窝网）  |
| 200023        | 请求超时                       |
| 200025        | 未知错误，一般配合描述分析        |
| 200027        | 蜂窝未开启（纯WiFi状态下返回该错误码） |
| 200038        | 异网取号网络请求失败   |
| 200048        | 用户未安装sim卡                |
